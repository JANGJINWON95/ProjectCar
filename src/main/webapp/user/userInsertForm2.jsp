...
//유효성체크 함수
function check() {
	if(document.user_insert_Form.user_id.value == "") {
		alert("ID를 입력하세요.");
		return false;
	}
...
<h1>회원가입</h1>
	<form action="./UserInsertPro.us" method="post" name="user_insert_Form" onSubmit="return check()">
		...
		<div class="field">
			<b>비밀번호 확인</b><br>	
			<input class="input" type="password" name="user_Repass"> <br>
		</div>
		...
		<div class="field">	
			<b>핸드폰 번호</b><br>	
			<input type='tel' name='user_hp'><br>
		</div>
		...
		<div class="field">	
			<b>면허번호</b><br>
			<input type='text' name='license_num' placeholder="'-'를 제거하고 작성해주세요." required > <br><br>
		</div>
